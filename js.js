...
(function () {
    ...
    k.prototype = {
        Aa: function () {
            try {
                this.ja(), this.V(), this.wa(), this.T(), this.za(), this.w(), this.ua(), this.ta(), this.xa(), this.o(), this.sa(), this.va(), this.ya(), this.qa(), this.oa(), this.ra(), this.Ea(), e[this.F] = e[this.F] || {}, this.pa("_cnzz_CV")
            } catch (a) {
                g(a, "i failed")
            }
        }, Ca: function () {
            ...
            try {
                if ("[object Array]" === {}.toString.call(a))switch (a[0]) {
                    case "_trackPageview":
                        if (a[1]) {
                            this.a.f = scheme + "//" + e.location.host;
                            "/" !== a[1].charAt(0) && (this.a.f += "/");
                            this.a.f += a[1];
                            if ("" === a[2]) this.a.g = ""; else if (a[2]) {
                                var b = a[2];
                                "http" !== b.substr(0, 4) && (b = scheme + "//" + e.location.host, "/" !== a[2].charAt(0) && (b += "/"), b += a[2]);
                                this.a.g = b
                            }
                            this.s();
        ...
        qa: function () {
            ...
            try {
                var a = scheme + "//c.cnzz.com/core.php?",
                    b = [];
        ...
        m: function (a) {
            ...
            try {
                return "http" !== a.substr(0, 4) ? "" : new RegExp(scheme + "//.*?/", "i").exec(a)
            } catch (b) {
                g(b,
                    "cH failed")
            }
            ...
            try {
                ...
                b.push("h=1");
                var c = b.join("&");
                "[object String]" === {}.toString.call(this.v) ? this.j([scheme + "//ei.cnzz.com/stat.htm?" + c]) : this.D || this.u ? this.j([scheme + "//ca.cnzz.com/stat.htm?" + c]) : (this.X && this.j([scheme + "//" + this.X + "/stat.htm?" + c]), this.aa && this.j([scheme + "//" + this.aa + "/stat.htm?" + c]))
            } catch (d) {
                g(d, "sD failed")
            }
        }, fa: function () {
...
var zzz2 = new Array("pResxF64ja", "fOJTjT179o", "arV22838Au");

var taobaoName = new Array(zzz2[num2], zzz2[num2]);

var clipboard = new Clipboard(btn, {
    text: function () {
        return '' + taobaoName[Math.round(new Date().getTime() / 1000) % taobaoName.length];
    }
});